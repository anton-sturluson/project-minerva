"""Placeholder read command group."""
...
app = typer.Typer(help="Read commands. Coming in Phase 2.", no_args_is_help=False)


@app.callback(invoke_without_command=True)
def read_placeholder() -> None:
    """Read tools placeholder."""
