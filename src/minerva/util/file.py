...
from util.encoder import FileJSONEncoder
...
class File:
    ...
    def write_to_s3(self, data: Any, indent: int | None = None):
        ...
        try:
            ...
            print("Endpoint connection error, check your network or "
            ...
            print("Read timeout error: The server took too long to respond.")

        except botocore.exceptions.S3UploadFailedError:
            print("Upload failed: Network or connection issue.")
